...
?>
	<a href="#content" class="back-to-top" title="Vai su" style="<?php echo $temp ?>: 2.0% !important;"><span class="fa fa-arrow-circle-o-up fa-2x"><span class="screen-reader-text">Link vai su</span></span></a>
<?php } ?>
<?php wp_footer(); ?>
</body>
</html>
